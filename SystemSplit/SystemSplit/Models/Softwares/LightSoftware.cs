public class LightSoftware:Software
    {
        ...
        {
            this.CapacityConsumption = this.CapacityConsumption + this.CapacityConsumption * 50 / 100;
            this.MemoryConsumption = this.MemoryConsumption - this.MemoryConsumption * 50 / 100;
        }
    }
